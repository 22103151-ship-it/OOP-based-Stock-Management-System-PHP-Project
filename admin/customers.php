...
include '../config.php';
use App\Core\Auth;
use App\Services\CustomerOverviewService;
Auth::requireRole('admin');

$overviewService = new CustomerOverviewService($conn);
$overview = $overviewService->getOverviewData();
$customers = $overview['customers'];
$total_pro = $overview['total_pro'];
$total_vip = $overview['total_vip'];
