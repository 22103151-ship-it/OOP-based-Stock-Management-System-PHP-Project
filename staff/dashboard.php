...
$counts = $metricsService->getDashboardCounts();
$customerOrderCounts = $metricsService->getCustomerOrderCounts();
$user_count = $counts['user_count'] ?? 0;
$supplier_count = $counts['supplier_count'] ?? 0;
...
$processing_customer_orders = $customerOrderCounts['shipped'] ?? 0;
$pending_customer_orders = $customerOrderCounts['pending'] ?? 0;
$staff_dots = $notificationService->getActiveDots('staff');
