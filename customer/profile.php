...
$profileService = new CustomerProfileService($conn);
...
$customer = $profileService->getProfile($customer_id);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($profileService->updateProfile($customer_id, [
        'name' => $name,
        'email' => $email,
        'phone' => $phone,
...
$support_history = $profileService->getSupportHistory($customer_id, 20);
$order_stats = $profileService->getOrderStats($customer_id);
$total_spent = $profileService->getTotalSpent($customer_id);
?>
