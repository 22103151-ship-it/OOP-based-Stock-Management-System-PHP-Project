...
$customer = $portalService->resolveCustomerByUserId($user_id);
...
$discount = $portalService->getDiscountConfig((string)$customer_type);
$base_discount = $discount['base_discount'];
$bulk_discount = $discount['bulk_discount'];
$bulk_threshold = $discount['bulk_threshold'];
$min_per_product = $discount['min_per_product'];

// Get cart count
$cart_count = $portalService->getCartTotalQuantity($customer_id);
...
$products = $portalService->getProductsForBrowse();
?>
